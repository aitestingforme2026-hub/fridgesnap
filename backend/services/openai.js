 ...
 * When mealType is provided, prepends a strict meal-type constraint.
 */
function buildRecipeSystemPrompt(units, mealType) {
  ...
  const mealTypeConstraint = mealType
    ? `MEAL TYPE: Generate ONLY ${mealType} recipes. Only use ingredients that naturally suit ${mealType}. Ignore fridge ingredients that don't fit.\n\n`
    : '';
